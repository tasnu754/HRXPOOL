    ...
    <div id="team">
      <div className="pt-14 space-y-10 ">
        <div className="text-center space-y-10 text-white mx-6">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-5xl font-extrabold text-blue-400">
          ...
          <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 ">
            ...
            className="group relative item-center justify-center overflow-hidden cursor-pointer hover:shadow-xl hover:shadow-black/30 transition-shadow rounded-md">
              <div className="h-96 w-72">
                <img
                  ...
                  src="./WhatsApp Image 2024-09-15 at 9.21.24 PM.jpeg"
                  alt=""
                />
              </div>
            ...
            className="group relative item-center justify-center overflow-hidden cursor-pointer hover:shadow-xl hover:shadow-black/30 transition-shadow rounded-md">
              <div className="h-96 w-72">
                <img
                  className="h-full w-full object-cover group-hover:scale-125 transition-transform duration-500"
                  src="./467671830_8959128707484914_3859786227211551858_n.jpg"
                  alt=""
                />
              </div>
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
             ...
             className="group relative item-center justify-center overflow-hidden cursor-pointer hover:shadow-xl hover:shadow-black/30 transition-shadow rounded-md">
              ...
              <div className="absolute inset-0  flex flex-col items-center justify-center px-4 text-center translate-y-[60%] group-hover:translate-y-0 transition-all">
                ...
                <p className="text-xl italic text-whitemb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-[#b8a6c1] mt-28">
                    Department- Sales & Communication <br /> Email: info@hrxpool.com
                </p>
              </div>
            </div>
            <div 
            ...
            className="group relative item-center justify-center overflow-hidden cursor-pointer hover:shadow-xl hover:shadow-black/30 transition-shadow rounded-md">
              ...
              <div className="absolute inset-0  flex flex-col items-center justify-center px-4 text-center translate-y-[60%] group-hover:translate-y-0 transition-all">
                ...
                Department- Branding <br /> Email: info@hrxpool.com
                </p>
              </div>
            </div>
            <div 
            ...
            className="group relative item-center justify-center overflow-hidden cursor-pointer hover:shadow-xl hover:shadow-black/30 transition-shadow rounded-md">
              <div className="h-96 w-72">
                <img
                  className="h-full w-full object-cover group-hover:scale-125 transition-transform duration-500"
                  src="./WhatsApp Image 2024-10-03 at 6.27.07 PM.jpeg"
                  alt=""
                />
              </div>
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
              <div className="absolute inset-0  flex flex-col items-center justify-center px-4 text-center translate-y-[60%] group-hover:translate-y-0 transition-all">
                ...
                <p className="text-lg italic text-whitemb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-[#bfa4cc] mt-36">
                  Web Developer <br /> Email: info@hrxpool.com
                </p>
              </div>
            </div>
            <div 
            ...
            className="group relative item-center justify-center overflow-hidden cursor-pointer hover:shadow-xl hover:shadow-black/30 transition-shadow rounded-md">
              <div className="h-96 w-72">
                <img
                  className="h-full w-full object-cover group-hover:scale-125 transition-transform duration-500"
                  src="./WhatsApp_Image_2024-01-11_at_6.36.48_PM-removebg (2).png"
                  alt=""
                />
              </div>
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
